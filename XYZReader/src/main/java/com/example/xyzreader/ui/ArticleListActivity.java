...
//        final View toolbarContainerView = findViewById(R.id.toolbar_container);
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        int listLandscape = getResources().getInteger(R.integer.list_column_landscape);

        StaggeredGridLayoutManager sglm = null;

        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            sglm = new StaggeredGridLayoutManager(listLandscape, StaggeredGridLayoutManager.VERTICAL);
        }
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            Log.d("Recycler View", mCursor.getString(ArticleLoader.Query.THUMB_URL));
            Glide.with(ArticleListActivity.this)
                    ...
                    .listener(new RequestListener<String, GlideDrawable>() {
                        ...
                        public boolean onResourceReady(GlideDrawable resource,
                            ...
                            holder.layoutBackground.setBackgroundColor(mMutedColor);
                            return false;
                        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            layoutBackground = (LinearLayout) view.findViewById(R.id.llBackground);
        }
    }
}
